...
export default function RefreshButton() {
 ...
 return <a href={href} className="fiq-refresh-button" aria-label={refreshing?"Sayfa yenileniyor":"Sayfayı yenile"} title="Sayfayı yenile" onClick={()=>setRefreshing(true)} aria-busy={refreshing}>
