    ...
    >
      ...
      >
        ...
        <div className="fiq-card-portrait pointer-events-none relative z-20 mx-auto mt-1 h-[72px] w-[72px] overflow-hidden rounded-[44%_44%_38%_38%/38%_38%_58%_58%] [transform:translateZ(8px)]">
          {safePhoto ? <img src={safePhoto} alt={player.name} className="h-full w-full object-cover object-[50%_18%]" draggable={false} /> : <div className="h-full w-full bg-[radial-gradient(circle_at_50%_23%,#c59270_0_17%,#8d6149_18%_30%,#16382f_31%_66%,#091c18_67%)] opacity-95" />}
        </div>
